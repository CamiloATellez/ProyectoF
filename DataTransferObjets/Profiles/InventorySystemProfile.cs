...
namespace DataTransferObjets.Profiles
{
    public class InventorySystemProfile : Profile
    {
        public InventorySystemProfile()
        {
            ...
            CreateMap<ProductRequest, Product>().ForMember(o => o.SerialNumber,b => b.MapFrom(z => z.Name));
            CreateMap<Product, ProductResponse>().ForMember(o => o.Name,b => b.MapFrom(z => z.SerialNumber))
